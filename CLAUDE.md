...
checkout to validate generated MIDI. FX pattern layout is asserted in libRemuxer GoogleTest (openmpt);
MIDI conversion for those fixtures is Integration (`FxMidiTests`). GoogleTest (Song/FileFormat/Wav +
